...
uses
  ...
  ufrmLayoutPicker in 'Forms\ufrmLayoutPicker.pas',
  ufrmLayoutToast in 'Forms\ufrmLayoutToast.pas',
  ...
  clsAnsiGrapheme in '..\Unicode to ascii converter\clsAnsiGrapheme.pas',
  clsAnsiAtomMap in '..\Unicode to ascii converter\clsAnsiAtomMap.pas',
  uCaretContextSniffer in 'Units\uCaretContextSniffer.pas',
  uCaretContextCache in 'Units\uCaretContextCache.pas',
  uAnsiBackspace in 'Units\uAnsiBackspace.pas',
  uCaretWatch in 'Units\uCaretWatch.pas',
  uUIAText in 'Units\uUIAText.pas',
  ...
  uAvroShieldVM in 'Units\uAvroShieldVM.pas',
