...
function TFontPickerCombo.HandleEditKey(uMsg: UINT; wParam: wParam; lParam: lParam): Boolean;
var
  Key: Word;
begin
  Result := False;
...
procedure TFontPickerCombo.DrawDropDownItem(DC: HDC; Index: Integer; Rect: TRect; State: TOwnerDrawState);
var
  C:                 TCanvas;
  Text:              string;
  TextR:             TRect;
