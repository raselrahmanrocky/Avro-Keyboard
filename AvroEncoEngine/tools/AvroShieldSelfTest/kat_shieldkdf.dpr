...
procedure CheckBytes(const AName: string; const Actual: TBytes;
  const ExpectedHex: string);
begin
  Check(AName, BytesToHex(Actual) = LowerCase(ExpectedHex),
...
begin
  ...
  CheckBytes('A.1 PRK', PRK,
    '077709362c2e32df0ddc3f0dc47bba6390b6c73bb50f9c3122ec844ad7c2b3e5');
  OKM := HkdfExpandSHA256(PRK, RangeBytes($F0, $F9), 42);
  CheckBytes('A.1 OKM', OKM,
    '3cb25f25faacd57a90434f64d0362f2a2d2d0a90cf1a5a4c5db02d56ecc4c5bf' +
    '34007208d5b887185865');

  WriteLn('=== HKDF-SHA256 RFC 5869 A.3 (empty salt/info) ===');
  PRK := HkdfExtractSHA256(nil, RepByte($0B, 22));
  CheckBytes('A.3 PRK', PRK,
    '19ef24a32c717b167f33a91d6f648bdf96596776afdb6377ac434c1c293ccb04');
  OKM := HkdfExpandSHA256(PRK, nil, 42);
  CheckBytes('A.3 OKM', OKM,
    '8da4e775a563c18f715f802a063c5a31b8a11f5c5ee1879ec3454e5f3c738d2d' +
    '9d201395faa4b61a96c8');

  WriteLn('=== PBKDF2-HMAC-SHA256 (hashlib cross-checked) ===');
  DK := Pbkdf2HMACSHA256(TEncoding.UTF8.GetBytes('password'),
    TEncoding.UTF8.GetBytes('salt'), 1, 32);
  CheckBytes('PBKDF2 c=1', DK,
    '120fb6cffcf8b32c43e7225256c4f837a86548c92ccc35480805987cb70be17b');
  DK := Pbkdf2HMACSHA256(TEncoding.UTF8.GetBytes('password'),
    TEncoding.UTF8.GetBytes('salt'), 2, 32);
  CheckBytes('PBKDF2 c=2', DK,
    'ae4d0c95af6b46d32d0adff928f06dd02a303f8ef3c251dfd6e2d85a95474c43');
  DK := Pbkdf2HMACSHA256(
    TEncoding.UTF8.GetBytes('passwordPASSWORDpassword'),
    TEncoding.UTF8.GetBytes('saltSALTsaltSALTsaltSALTsaltSALTsalt'), 4096, 32);
  CheckBytes('PBKDF2 c=4096', DK,
